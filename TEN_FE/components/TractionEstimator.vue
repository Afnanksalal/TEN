  ...
  <div class="p-6 bg-white rounded-lg shadow-md max-w-4xl mx-auto my-8">
    ...
    <form @submit.prevent="estimateTraction" class="space-y-6 mb-8 p-6 border border-gray-200 rounded-lg bg-gray-50">
      ...
      <button
        type="submit"
        :disabled="loading"
        class="w-full flex justify-center py-2 px-4 border border-transparent rounded-md shadow-sm text-lg font-medium text-white bg-teal-600 hover:bg-teal-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-teal-500 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
      >
